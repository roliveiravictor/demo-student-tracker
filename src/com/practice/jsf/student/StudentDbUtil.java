...
//Helper Class to control data flow
public class StudentDbUtil {
	...
	{
		//Context: Also known as Web Application, configures Engine, Hosts, Error Messages, etc.
		Context context = new InitialContext();
		
		//JNDI: Allows clients to discover and look up data and objects via name.
